...
HOST_ENV_VARS=(PACKAGE_TYPE APP SOURCE_GIT BUILD_SCRIPT REPO_OWNER REPO_NAME FPR TARGETS CACHE_MODE)
TRIMMED_ENV_VARS=" PACKAGE_TYPE REPO_OWNER REPO_NAME FPR TARGETS CACHE_MODE "
